<template>
  <div id="app">
    <a href="tel:0696495851" class="stickyPhone">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40" color="#ffff" fill="none">
        <path d="M14 3V6M19 5L17 7M21 10H18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
...
initMetaPixel('1384549462670537') // ← Remplace par ton vrai Pixel ID

console.log('initMetaPixel: ', )
*/
</script>
...
#app {
  font-family: Noto Sans Arabic, Avenir, Helvetica, Arial, sans-serif;
...
.stickyPhone {
  ...
  animation: call 1s infinite ease-in-out;
